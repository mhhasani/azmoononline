    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('address', models.CharField(default='9fznswqjmi', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Q_image', models.ImageField(blank=True, default='questions_image/8.jpg', upload_to='questions_image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.CharField(choices=[('', '---Please select your choice---'), ('1', '1'), ('2', '2'), ('3', '3'), ('4', '4')], max_length=200, null=True)),
                ('examiner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='formapp.examiner')),
                ('participant', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('question', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='formapp.question')),
            ],
        ),
        migrations.AddField(
