# Generated by Django 3.1.7 on 2021-08-18 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('address', models.CharField(default='mt4pcqfskz', max_length=200)),
                ('participant_number', models.IntegerField(default=0)),
                ('azmoon_number', models.IntegerField(default=0)),
                ('owner', models.IntegerField(null=True)),
                ('student', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(null=True), size=None)),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partclass', models.ManyToManyField(blank=True, to='formapp.Class')),
